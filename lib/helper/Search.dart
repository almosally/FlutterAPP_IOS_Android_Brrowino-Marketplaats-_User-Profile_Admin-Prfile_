...
import 'package:borrowinomobileapp/views/OfferItemBuilder.dart';
...
class _SearchState extends State<SearchList> {
  ...
  String _error;
  List<SearchOffer> _results = List();
  ...
  void performSearch(String query) async {
    ...
    final repos = await CallApi.getOffersWithSearchQuery(query);
  ...
  Widget buildBody(BuildContext context) {
    if (_isSearching) {
      return CenterTitle('Searching offers...');
    } else if (_error != null) {
      ...
      return ListView.builder(
          ...
          itemBuilder: (BuildContext context, int index) {
            return OfferItemBuilder(_results[index]);
          });
    }
  }
}
