...
class RequestedOffers extends StatefulWidget {
  @override
  _RequestedOffersPageState createState() => new _RequestedOffersPageState();
}

class _RequestedOffersPageState extends State<RequestedOffers> {
  int id;
  ...
  void _getReportedOffers() async {
    ...
    final String url = "http://api.borrowino.ga/user/received-requests";
  ...
  void _navigationToNewsDetail(BuildContext context, UserOfferDetails userofferDetail, Request request) {
    Navigator.push(context, MaterialPageRoute(builder: (context) {
      return RequestedUserOfferInfo(userofferDetail, request);
    }));
  }
